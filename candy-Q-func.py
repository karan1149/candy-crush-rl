...
'''
Features:
number of valid pairs in state
number in a row produced by switched: testSwitch
max count of a number in a row: maxCount[0]
Max count of a number in a col: maxCount[1]
'''
